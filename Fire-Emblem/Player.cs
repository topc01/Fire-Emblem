...
public class Player
{
    ...
    public CharacterAnalyzer GetCharacter(int selected) => _characters[selected]
                                                   ?? throw new Exception("No se encontró en el equipo");
    public CharacterAnalyzer[] GetLiveCharacters()
    ...
    private void Choose(CharacterAnalyzer[] characters, View view)
    {
        ...
        Controller.Character = characters[choice].Stats;
    }

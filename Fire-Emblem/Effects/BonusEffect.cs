...
{
    public BonusEffect(StatType targetStat, int constantFactor) : base(targetStat, constantFactor){}
    public BonusEffect(StatType targetStat, double linearFactor) : base(targetStat, linearFactor){}
    public BonusEffect(StatType targetStat, double linearFactor, int constantFactor) : base(targetStat, linearFactor, constantFactor){}
    public override void Apply(CharacterController controller)
    {
        CharacterStats baseStats = controller.Character;
        AttackOrientedModifiedStats stats = controller.Bonus;
        switch (TargetStat)
        {
            case StatType.Atk:
